...
def picky_piggy(opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    if opponent_score > 99:
        return picky_piggy(opponent_score % 10 + opponent_score // 10 % 10 * 10)
...
def swine_swap(score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    if score > 0 and sqrt(score) == floor(sqrt(score)):
        return True
    else:
        return False
    # END PROBLEM 4
...
def play(strategy0, strategy1,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            if num_rolls == 0:
                score0 += take_turn(0, score1, dice)
            else:
            ...
            if num_rolls == 0:
                score1 += take_turn(0, score0, dice)
            else:
...
def is_always_roll(strategy, goal=GOAL_SCORE):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    if 'always' in strategy.__name__ or 'always' in strategy.__qualname__:
        return True
    return False
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    i, max_score = 1, 0
    while i < 11:
        average_roll = make_averaged(roll_dice, total_samples)
        max_score_i = average_roll(i, dice)
...
def swine_strategy(score, opponent_score, threshold=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    score = picky_piggy(opponent_score) + score
    if score < opponent_score and swine_swap(score):
        return 0
